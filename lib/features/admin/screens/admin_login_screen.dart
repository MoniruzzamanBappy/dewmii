                    ...
                    child: Container(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Center(child: _AdminLoginLogo(size: 92)),
...
class _AdminLoginLogo extends StatelessWidget {
  final double size;

  const _AdminLoginLogo({required this.size});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Image.asset(
        _AdminLoginScreenState._logoPath,
        fit: BoxFit.contain,
